...
INSERT INTO users (username, password, email, role) VALUES
                                                    ('ivan_petrov', 'password123', 'ivan.petrov@example.com', 'ROLE_TUTOR'),
                                                    ('elena_sidorova', 'qwerty789', 'elena.sidorova@example.com', 'ROLE_TUTOR'),
                                                    ('admin', '111', 'admin@example.com', 'ROLE_ADMIN'),
                                                    ('sergey_kuznetsov', 'securePass', 'sergey.kuznetsov@example.com', 'ROLE_STUDENT'),
                                                    ('maria_orlova', 'mypass1234', 'maria.orlova@example.com', 'ROLE_STUDENT');
